...
- [x] Allocation and artifact measurements establish reproducible resource ceilings without wall-clock assertions.
...
and evidence commands plus deterministic artifact/allocation ceilings.
...
SVG, logo, and adverse decoding, all enforced coverage scopes, and fuzz-target
compilation.
...
- 2026-08-07: Criterion performance tests, their dependency, and their release
  command were removed by owner direction. Correctness-oriented allocation
  ceilings remain.
