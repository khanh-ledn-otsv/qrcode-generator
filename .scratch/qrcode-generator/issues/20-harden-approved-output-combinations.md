...
- [x] A generated matrix covers every selectable foreground, background, transparency, module style, finder style, logo state, profile, and required payload class.
...
- [x] Performance, allocation, and compressed bundle measurements establish reproducible baselines and flag regressions without flaky wall-clock unit assertions.

## Answer

Added a generated 192-row approved-output matrix spanning all seven selectable
...
evidence locations, and remaining manual physical-device policy. Automated
...
smoke run, fuzz-target compilation, and the 154,450-byte compressed WASM ceiling.
