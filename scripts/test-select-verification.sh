...
assert_scope "meta" "scripts/select-pages-deployment.sh"
assert_scope "meta" "scripts/select-verification.sh"
assert_scope "meta" "scripts/test-ci-build-contract.sh"
assert_scope "meta" "scripts/test-select-pages-deployment.sh"
assert_scope "meta" "scripts/test-workflow-manual-deployment.sh"
assert_scope "meta" "scripts/test-workflow-action-pins.sh"
